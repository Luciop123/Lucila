...
bot = telebot.TeleBot('7519734348:AAFoQEvymQXUcyhqSYPztIE9cwCiwp-ZGcU')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet purchase now from:- @NOOB_AM"
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "FREE KA KUCH NI MILTA BHAI BUY KRNA H TO DM KR:- @NOOB_AM 🙇."
    bot.reply_to(message, response)
...
def show_all_users(message):
    ...
    if user_id in admin_id:
        ...
        response = "FREE ME KUCH NI MILTA BHAI BUY KRNA H TO DM KR:- @NOOB_AM ❄."
    bot.reply_to(message, response)
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = "FREE ME KUCH NI MILTA BHAI BUY KRNA H TO DM KR:- @RAHUL_DDOS ❄."
        bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi @NOOB_AM")
...
Buy From :- @NOOB_AM
Official Channel :- https://t.me/NOOB_AM_VIP
'''
...
3. MAKE SURE YOU JOINED https://t.me/NOOB_AM_VIP OTHERWISE NOT WORK
